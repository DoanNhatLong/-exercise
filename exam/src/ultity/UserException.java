...
//    }
    ...
    public static void validateID(String idQuestion, String idAnswer) throws UserException {
        if (Objects.equals(idQuestion, idAnswer)) {
            throw new UserException(ERROR_INPUT);
        }
    }

    public static void validateCorrect(String correct, String idAnswer1,String idAnswer2,String idAnswer3,String idAnswer4 ) throws UserException {
        if (!(correct.contains(idAnswer1) || correct.contains(idAnswer2)||correct.contains(idAnswer3)||correct.contains(idAnswer4))) {
            throw new UserException(ERROR_INPUT);
        }
    }
